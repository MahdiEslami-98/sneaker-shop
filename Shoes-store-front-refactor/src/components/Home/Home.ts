export const Loading = () => {
  return `
    <div class="container mx-auto h-full" id="FP">
      <div class="flex h-full w-full items-center justify-center">
        <img src="./Untitled-4 (1).png" alt="" class="h-16 w-16" />
        <span class="text-4xl font-bold">Shoea</span>
      </div>
      <div
        role="status"
      ...
      >
        <svg
          aria-hidden="true"
          class="inline h-10 w-10 animate-spin fill-black text-gray-200"
          viewBox="0 0 100 101"
          fill="none"
...
export const HomePage = () => {
  return `<div class="relative h-full w-full bg-hero" onclick="navigate('/slider')">
  <div
    id="alert"
